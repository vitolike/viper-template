            ...
            <div class="navbar-brand">
                <a href="{{url('/')}}">
                    ...
                    <span class="logo-text">
                        <img src="{{getFile(config('location.logoIcon.path').'admin-logo.png' )}}" alt="homepage"
                             class="dark-logo"/>
                        <img src="{{getFile(config('location.logoIcon.path').'admin-logo.png' )}}" class="light-logo"
                             alt="homepage"/>
                    </span>
                </a>
            </div>
