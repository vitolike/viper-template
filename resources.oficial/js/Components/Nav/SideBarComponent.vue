            ...
            <ul>
                <li class="mb-3">
                    <div class="flex justify-between w-full gap-4">
                        ...
                        <button v-if="!isAuthenticated" @click.prevent="$router.push('/landing/spin')" class="btn-menu-rotate border border-red-500">
                ...
                <li v-if="!isAuthenticated" class="mb-4 mt-3">
...
<a href="https://sosfortunes.shop/tournament/brasileirao/1" class="sidebar-link "><i aria-hidden="true"  class="fa-solid fa-house"></i> Brasileirão</a>
<br>
<a href="https://sosfortunes.shop/tournament/brasileirao/1" class="sidebar-link "><i aria-hidden="true"  class="fa-solid fa-house"></i> Brasileirão</a>
            ...
            <div class="mt-4">
                ...
                <div v-else class="grid grid-cols-2 gap-4 mt-4 mb-4">
                    <RouterLink v-for="(category, index) in categories" :key="index" :to="{ name: 'casinosAll', params: { provider: 'all', category: category.slug }}" active-class="category-active" class="h-20 bg-gray-300/20 flex flex-col items-center justify-center text-center p-3 hover:dark:bg-gray-700/20 dark:bg-gray-700 rounded-xl">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <RouterLink :to="{ name: 'profileWallet' }" active-class="category-active" class="bg-gray-300/20 flex flex-col items-center justify-center text-center p-3 hover:dark:bg-gray-700/20 dark:bg-gray-700 rounded-xl">
                        <img :src="`/assets/images/icons/wallet-money.svg`" alt="" width="35">
                        <span class="text-[12px] mt-2">{{ $t('Wallet') }}</span>
                    </RouterLink>
                </div>
                <div>
                    <RouterLink :to="{ name: 'favoritePage' }" active-class="category-active" class="bg-gray-300/20 flex flex-col items-center justify-center text-center p-3 hover:dark:bg-gray-700/20 dark:bg-gray-700 rounded-xl">
            ...
            <div class="grid md:grid-cols-2 grid-cols-3 gap-4 mt-4">
                <div>
